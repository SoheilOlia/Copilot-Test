...
import squareImage from "@/assets/sq.jpg";
      ...
      >
        <section className="mb-12 flex pl-16">
          <div className="w-1/2 h-[400px] overflow-hidden rounded-lg">
            <Image
              src={squareImage}
              alt="Square POS Experiment Cover"
          ...
          <div className="w-1/2">
            <div className="px-12 h-full flex flex-col justify-between">
              <p className="text-5xl leading-14 font-light text-text-standard mb-2">
                Experimental integration of Square's point-of-sale system with
                voice automation
              </p>
              ...
              <Link
                ...
                onClick={(e) => {
                  ...
                  setTimeout(() => {
                    router.push("/project/square-pos-experiment/workspace");
                  }, 400); // Match the exit animation duration
                }}
              >
                <Button
                  variant="prominent"
                  className="w-fit px-12 py-8 text-xl"
                >
                  Continue session
                </Button>
              </Link>
